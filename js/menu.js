...
let boxList = document.querySelectorAll('.box-list > section');
let closeBtnEls = document.querySelectorAll('header .hamburger > div');

const boxListWrap = document.querySelector('.box-list');
const closeBtn = document.querySelector('header .hamburger');
const menuTitle = document.querySelector('.top-menu > span');
const logoLink = document.querySelector('header > nav > h1 ');
...
function selectBox(e){
    ...
    if(idx === 0) menuTitle.innerHTML = 'HOME';
    else if(idx === 1) menuTitle.innerHTML = 'SYNOPSIS';
    else if(idx === 2) menuTitle.innerHTML = 'CAST';
    else if(idx === 3) menuTitle.innerHTML = 'TRAILER';
...
function closeMenu(){
    if(isClose === false){
        ...
        boxList[beforeIdx].classList.add('zoom');

        if(beforeIdx === 0) menuTitle.innerHTML = 'HOME';
        else if( beforeIdx === 1) menuTitle.innerHTML = 'SYNOPSIS';
        else if( beforeIdx === 2) menuTitle.innerHTML = 'CAST';
        else if( beforeIdx === 3) menuTitle.innerHTML = 'TRAILER';
        hamburgerOpen();
        isClose = false;
        console.log('isClose', isClose);
    }
